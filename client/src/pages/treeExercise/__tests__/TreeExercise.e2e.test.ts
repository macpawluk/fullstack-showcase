...
describe("Tree Exercise e2e tests", () => {
  test(
    "Page properly loads persons data",
    async () => {
  ...
  test(
    "Page properly loads contacts data",
    async () => {
      const browser = await puppeteer.launch({
        headless: false
      });
      ...
      await clickElementByAttributte(
        page,
        "data-test-item",
        "person-list-item"
      );
  ...
  test(
    "Page properly reloads contacts data when range is changed",
    async () => {
      const browser = await puppeteer.launch({
        headless: false
      });
  ...
  test(
    "Page properly validates NaN input",
    async () => {
  ...
  test(
    "Page properly validates too big input",
    async () => {
  ...
  test(
    "Page properly validates too small input",
    async () => {
